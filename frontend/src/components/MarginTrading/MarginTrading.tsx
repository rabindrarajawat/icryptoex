...
export const MarginTrading: React.FC<{
  activeMenu: string;
  ...
  const [selectedOption, setSelectedOption] = useState<string | null>("Long");
                    ...
                    {activePerformance === "Performance" && (
                      <div>
                        <div className=" text-dark pt-4 ms-5">
                          ...
                          >
                            <span className={`ps-2 ${styles.tolownum}`}>
                              51,855.50
                            </span>

                            <h6 className={`ps-3 ${styles.tohignum}`}>
                              51,855.50
                            </h6>
                          </div>
                          <div
                            className={`d-flex flex-row bd-highlight mb-3 ${styles.setlh}`}
                          >
                          ...
                          <div
                            className={`d-flex flex-row bd-highlight mb-3 pb-2 `}
                          >
                            <span className={`ps-1 ${styles.tolownum}`}>
                              51,855.50
                            </span>

                            <span className={`ps-3 ${styles.tohignum}`}>
                              51,855.50
                            </span>
                          </div>
                          <h6 className="text-dark ">ANALYST ESTIMATES</h6>
                  ...
                  <div className="d-flex flex-row bd-highlight  ms-5 mt-5 pt-4 ps-4">
                    <div
                      className={`ms-5 mt-5 ps-4 text-success ${
                        selectedOption === "Long" ? "text-primary" : ""
                      }`}
                    ...
                    <div
                      className={`ms-2 mt-5 ps-4 text-danger ${
                        selectedOption === "Short" ? "text-danger" : ""
                      }`}
